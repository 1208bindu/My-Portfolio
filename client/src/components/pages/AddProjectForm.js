...
const AddProjectForm = () => {
  ...
  const _handelsubmit = (e) => {
    e.preventDefault();
    if (Object.keys(newProj).length >= 3 && selectedImage) {
      console.log("adding");
    ...
    <div className="AddProjectFrom center">
      ...
      <div className="row ">
        <form
          ...
          className="col s12 m6 offset-m3  addProjectForm"
        >
          {/* Project Name */}
          ...
          <div className="input-field col s12 m6 offset-m3">
            <input
              ...
              className="validate"
              onChange={(e) => {
                setNewProj({ ...newProj, source_code: e.target.value });
              }}
              required
            />
          ...
          <div className="input-field col s12 m6 offset-m3">
            <input
              ...
              className="validate"
              onChange={(e) => {
                setNewProj({ ...newProj, url: e.target.value });
              }}
            />
          ...
          <div className="input-field col s12 m6 offset-m3">
            <textarea
              ...
              required
            ></textarea>
            <label htmlFor="description" id="desLabel">
              Textarea
            </label>
          </div>
          {/* Button */}
          ...
          >
            <button
              type="submit"
              className="btn indigo accent-4 waves-effect waves-light"
            >
              send
            </button>
