    ...
    <nav>
      ...
      <div className=" indigo accent-4 nav-wrapper">
        ...
        <ul id="nav-mobile" className="right hide-on-med-and-down navbar">
          ...
          <li>  <NavLink exact to="/" > My Porfolio </NavLink>  </li>
          
          <li >
            <NavLink exact activeClassName="activeNav" to="/projects">My Projects</NavLink>
          </li>
         
          <li >
            <NavLink to="/resumes" activeClassName="activeNav">My Resume</NavLink>
          </li>
          <li >
