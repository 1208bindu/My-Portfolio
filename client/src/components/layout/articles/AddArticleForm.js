  ...
  return (
    ...
    <div className="row">
      ...
      <div className="input-field col s12  ">
        ...
        <label htmlFor="title" className="desLabel" >File Location</label>
      </div>
        ...
        <div className="input-field col s12  ">
          ...
          <label htmlFor="content" id="desLabel">Article Description</label>
        </div>
        

        {/* Button */}
        <div className="col s12 m6 offset-m3" style={{ display:'flex' , alignItems: 'center',  justifyContent:'center' }}>
          <button type="submit" className="btn indigo accent-4 waves-effect waves-light">Add</button>
        </div>
