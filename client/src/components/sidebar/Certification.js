  ...
  var q = document.getElementById("psinter");
    ...
    <ul className=" list_certificates">
      <li >
        ...
        <p onClick={()=>displayPython()} >The joy of computing using Python - NPTEL Online Certification </p>
      ...
      <li >
        <p onClick={()=>displayR()} >Introduction to R - NPTEL Online Certification </p>
         <div id="R">
            <img src={R} alt="nptel"/>   
          </div>
     </li>
      ...
      <li >
        <p onClick={()=>displayPsBasic()} >Programming Skills Basics - HackerRank </p>
         <div id="psbasic">
      ...
      <li >
        <p onClick={()=>displayPsinter()} >Programming Skills Intermediate - HackerRank </p>
         <div id="psinter">
